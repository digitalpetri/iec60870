 ...
 *
 * <p>Each in-scope type identification has a dedicated record in the {@code
 * com.digitalpetri.iec60870 .asdu.object} package implementing this interface. The information
 * object address (IOA) framing is handled centrally by {@link Asdu.Serde}; the per-type {@link
 * InformationObjectCodec} only encodes and decodes the elements that follow the IOA.
 */
