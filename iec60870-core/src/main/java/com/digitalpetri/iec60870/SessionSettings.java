 ...
 * that parameterize a session are protocol-specific — for example the cs104 {@code ApciSettings}
 * carries the 104 {@code k}/{@code w} window and the {@code t0}-{@code t3} timers — so the client
 * and server configurations hold this neutral handle and the binding that assembles the session
 * downcasts it to the type it understands.
 *
