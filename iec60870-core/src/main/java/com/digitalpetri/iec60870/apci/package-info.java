 ...
 *
 * <p>Every IEC 104 message on the wire is an {@link com.digitalpetri.iec60870.apci.Apdu}: a
 ...
 * com.digitalpetri.iec60870.apci.ControlField} carries one of three formats:
 *
 * <ul>
 *   <li>{@link com.digitalpetri.iec60870.apci.ControlField.TypeI} — numbered information transfer;
 *       the only format that carries an ASDU. It pairs a send sequence number N(S) with a receive
 *       sequence number N(R).
 *   <li>{@link com.digitalpetri.iec60870.apci.ControlField.TypeS} — numbered supervisory
 *       acknowledge; carries only a receive sequence number N(R) to acknowledge received I-format
 *       APDUs.
 *   <li>{@link com.digitalpetri.iec60870.apci.ControlField.TypeU} — unnumbered control function
 *       (STARTDT, STOPDT, or TESTFR), modeled by {@link com.digitalpetri.iec60870.apci.UFunction}.
 * </ul>
 *
 * <h2>Wire format</h2>
 *
 ...
 * com.digitalpetri.iec60870.apci.ControlField.Serde} and {@link
 * com.digitalpetri.iec60870.apci.Apdu.Serde}). Those classes write into and read from a
