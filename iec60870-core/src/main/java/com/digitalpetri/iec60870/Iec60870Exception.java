 ...
 */
public class Iec60870Exception extends RuntimeException {

  /** Creates an exception with no detail message or cause. */
  public Iec60870Exception() {
    super();
  }
   ...
   */
  public Iec60870Exception(String message) {
    super(message);
  }
   ...
   */
  public Iec60870Exception(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @param cause the underlying cause of the failure.
   */
  public Iec60870Exception(Throwable cause) {
    super(cause);
  }
}
