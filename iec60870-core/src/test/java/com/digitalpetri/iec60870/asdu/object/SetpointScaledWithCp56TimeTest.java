...
class SetpointScaledWithCp56TimeTest {
   ...
   *
   * <ul>
   *   <li>SVA: scaled value -1234 = 0xFB2E (two's complement) LE = <b>2E FB</b>
   ...
   * </ul>
   */
  private static final String GOLDEN_HEX = "2EFB8539301E0A490614";

  private static SetpointScaledWithCp56Time representative() {
    return new SetpointScaledWithCp56Time(
  ...
  void encodeProducesGoldenBytes() {
    ...
    try {
      SetpointScaledWithCp56Time.Serde.encode(representative(), buffer);
  ...
  void decodeRoundTripsAndConsumesBuffer() {
    ...
    try {
      SetpointScaledWithCp56Time decoded =
          SetpointScaledWithCp56Time.Serde.decode(InformationObjectAddress.of(100), buffer);
