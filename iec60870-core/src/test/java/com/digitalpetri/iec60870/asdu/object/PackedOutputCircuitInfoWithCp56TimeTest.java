...
class PackedOutputCircuitInfoWithCp56TimeTest {
   ...
   *
   * <ul>
   *   <li>OCI: GC(0x01) | CL2(0x04) = <b>05</b>
   *   <li>QDP: SB(0x20) | IV(0x80) = <b>A0</b>
   ...
   * </ul>
   */
  private static final String GOLDEN_HEX = "05A0881339301E0A490614";

  private static PackedOutputCircuitInfoWithCp56Time representative() {
    return new PackedOutputCircuitInfoWithCp56Time(
        InformationObjectAddress.of(100),
        new Oci(true, false, true, false),
        new Qdp(false, false, true, false, true),
        new Cp16Time2a(5000),
  ...
  void encodeProducesGoldenBytes() {
    ...
    try {
      PackedOutputCircuitInfoWithCp56Time.Serde.encode(representative(), buffer);
  ...
  void decodeRoundTripsAndConsumesBuffer() {
    ...
    try {
      PackedOutputCircuitInfoWithCp56Time decoded =
  ...
  @Test
  void cp16ElapsedTimeOutOfRangeIsRejected() {
