...
class SetpointShortFloatWithCp56TimeTest {
   ...
   *
   * <ul>
   *   <li>R32: 1.5f = IEEE 754 0x3FC00000, little-endian = <b>00 00 C0 3F</b>
   ...
   * </ul>
   */
  private static final String GOLDEN_HEX = "0000C03F8539301E0A490614";

  private static SetpointShortFloatWithCp56Time representative() {
    return new SetpointShortFloatWithCp56Time(
  ...
  void encodeProducesGoldenBytes() {
    ...
    try {
      SetpointShortFloatWithCp56Time.Serde.encode(representative(), buffer);
  ...
  void decodeRoundTripsAndConsumesBuffer() {
    ...
    try {
      SetpointShortFloatWithCp56Time decoded =
          SetpointShortFloatWithCp56Time.Serde.decode(InformationObjectAddress.of(100), buffer);
