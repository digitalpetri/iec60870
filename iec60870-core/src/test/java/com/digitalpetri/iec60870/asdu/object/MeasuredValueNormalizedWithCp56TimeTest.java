...
class MeasuredValueNormalizedWithCp56TimeTest {
   ...
   * </ul>
   */
  private static final String GOLDEN_HEX = "0040A139301E0A490614";

  private static MeasuredValueNormalizedWithCp56Time representative() {
    return new MeasuredValueNormalizedWithCp56Time(
  ...
  void encodeProducesGoldenBytes() {
    ...
    try {
      MeasuredValueNormalizedWithCp56Time.Serde.encode(representative(), buffer);
  ...
  void decodeRoundTripsAndConsumesBuffer() {
    ...
    try {
      MeasuredValueNormalizedWithCp56Time decoded =
