 ...
 *
 * <p>This package adapts the transport-neutral abstractions in {@code com.digitalpetri.iec60870} to
 * a concrete Netty pipeline. The two reusable channel handlers in this package form the {@link
 * io.netty.buffer.ByteBuf}-to-{@link com.digitalpetri.iec60870.apci.Apdu} boundary:
 *
 * <ul>
 *   <li>{@link com.digitalpetri.iec60870.transport.tcp.Iec104FrameDecoder} reads length-delimited
 *       APDU frames off the wire and emits decoded {@link com.digitalpetri.iec60870.apci.Apdu}
 *       messages.
 *   <li>{@link com.digitalpetri.iec60870.transport.tcp.Iec104FrameEncoder} serializes outbound
 *       {@link com.digitalpetri.iec60870.apci.Apdu} messages back onto the wire.
 * </ul>
 *
