 ...
 * assertion is anchored to {@code iec60870-test-interop/docker/INTEROP-CONTRACT-CS101.md}, which
 * reuses the CS104 {@code INTEROP-CONTRACT.md} point image with CS101 sizing ({@code
 * ProtocolProfile(1, 1, 2, 255)} — COT&nbsp;1, CA&nbsp;1, IOA&nbsp;2) and balanced link settings
 * ({@code LinkSettings.balanced()}, link address 1, length 1).
 *
 ...
 * CS104 interop tests use, now carrying {@code socat} and the {@code interop_cs101} CS101 peer.
 */
@Tag("interop")
