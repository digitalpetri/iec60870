 ...
 * arrived.
 *
 * <p>Subscribe an instance to {@link com.digitalpetri.iec60870.client.Iec60870Client#events()}
 * before connecting to avoid missing early lifecycle events. Events are recorded in arrival order;
 * the collector requests unbounded demand so it never applies back-pressure to the client's
 * callback executor.
 */
