...
class Bitstring32WithCp56TimeTest {
   ...
   * </ul>
   */
  private static final String GOLDEN_HEX = "78563412A139301E0A490614";

  private static Bitstring32WithCp56Time representative() {
    return new Bitstring32WithCp56Time(
  ...
  void encodeProducesGoldenBytes() {
    ...
    try {
      Bitstring32WithCp56Time.Serde.encode(representative(), buffer);
  ...
  void decodeRoundTripsAndConsumesBuffer() {
    ...
    try {
      Bitstring32WithCp56Time decoded =
          Bitstring32WithCp56Time.Serde.decode(InformationObjectAddress.of(100), buffer);
