...
class MeasuredValueScaledWithCp56TimeTest {
   ...
   *
   * <ul>
   *   <li>SVA: value 4660 = 0x1234 LE = <b>34 12</b>
   ...
   * </ul>
   */
  private static final String GOLDEN_HEX = "3412A139301E0A490614";

  private static MeasuredValueScaledWithCp56Time representative() {
    return new MeasuredValueScaledWithCp56Time(
  ...
  void encodeProducesGoldenBytes() {
    ...
    try {
      MeasuredValueScaledWithCp56Time.Serde.encode(representative(), buffer);
  ...
  void decodeRoundTripsAndConsumesBuffer() {
    ...
    try {
      MeasuredValueScaledWithCp56Time decoded =
          MeasuredValueScaledWithCp56Time.Serde.decode(InformationObjectAddress.of(100), buffer);
