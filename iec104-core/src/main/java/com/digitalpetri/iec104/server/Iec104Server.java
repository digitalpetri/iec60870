 ...
 *
 * <p>A server is built from a {@link com.digitalpetri.iec104.transport.ServerTransport} and a
 * {@link ServerConfig} (the {@link DefaultIec104Server} implementation drives any transport; the
 ...
 * }</pre>
 */
public interface Iec104Server extends AutoCloseable {

  /**
   * Starts the server, binding its transport and accepting connections.
   *
   * @throws com.digitalpetri.iec104.Iec104Exception if the transport fails to bind.
   */
  void start();
   ...
   *
   * @throws com.digitalpetri.iec104.Iec104Exception if stopping the transport fails.
   */
  void stop();
