...
public interface ServerContext {
   ...
   *
   * <p>Reports every {@linkplain com.digitalpetri.iec104.point.PointCapability#REPORTED reported}
   ...
   * com.digitalpetri.iec104.asdu.Cause#UNKNOWN_COMMON_ADDRESS}.
   *
   ...
   * com.digitalpetri.iec104.asdu.Cause#UNKNOWN_COMMON_ADDRESS}; if the station hosts no point at
