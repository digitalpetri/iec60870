 ...
 *
 * <p>Obtain a {@code CommandService} from {@link Iec104Client#commands()}. The primary methods are
 * {@link #send(Command, CommandMode)} (blocking) and {@link #sendAsync(Command, CommandMode)}
...
public interface CommandService {
   ...
   * @throws com.digitalpetri.iec104.ConnectionClosedException if the connection is closed while the
   *     command is in flight.
   * @throws com.digitalpetri.iec104.ProtocolTimeoutException if the confirmation does not arrive
