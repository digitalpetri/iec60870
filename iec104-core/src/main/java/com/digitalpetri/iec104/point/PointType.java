...
public enum PointType {
   ...
   */
  DOUBLE_POINT(DoublePointState.class),
   ...
   */
  NORMALIZED(NormalizedValue.class),
   ...
   */
  INTEGRATED_TOTALS(BinaryCounterReading.class);

  private final Class<?> valueClass;

  PointType(Class<?> valueClass) {
    this.valueClass = valueClass;
  }

  /**
   * Returns the natural Java representation of a value of this point type, as carried by {@link
   * PointValue#value()}.
   *
   * <p>The mapping is {@link Boolean} for {@link #SINGLE_POINT}, {@link DoublePointState} for
   * {@link #DOUBLE_POINT}, {@link Vti} for {@link #STEP_POSITION}, {@link Integer} for {@link
   * #BITSTRING32}, {@link NormalizedValue} for {@link #NORMALIZED}, {@link Short} for {@link
   * #SCALED}, {@link Float} for {@link #SHORT_FLOAT}, and {@link BinaryCounterReading} for {@link
   * #INTEGRATED_TOTALS}.
   *
   * @return the natural Java value class for this point type.
   */
